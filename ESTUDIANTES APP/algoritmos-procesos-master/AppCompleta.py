...
class AppCompleta:
    ...
    def _crear_interfaz_pagos(self):
        ...
        self.label_mensualidad = ttk.Label(frame_info, text="$0.00")
        ...
        self.label_deuda = ttk.Label(frame_info, text="$0.00")
    ...
    def registrar_estudiante(self):
        try:
            ...
            if edad < 15 or edad > 80:
                raise ValueError("Edad debe estar entre 15 y 80 años")
    ...
    def generar_estado_cuenta(self):
        try:
            ...
            messagebox.showinfo("Estado de Cuenta", 
                ...
                f"Mensualidad actual: ${estado_cuenta['mensualidad_actual']:.2f}\n"
                f"Total pagado: ${estado_cuenta['total_pagado']:.2f}\n"
                f"Deuda actual: ${estado_cuenta['deuda_actual']:.2f}\n"
